...
{
    Task CreateStreamAsync(CreateStreamSpec spec, CancellationToken cancellationToken = default);
    Task UpdateStreamAsync(UpdateStreamSpec spec, CancellationToken cancellationToken = default);
    ...
    Task CreateConsumerAsync(CreateConsumerSpec spec, CancellationToken cancellationToken = default);
